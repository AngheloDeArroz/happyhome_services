...
export default async function NewListingPage() {
  ...
  if (!user) {
    return (
      <div className="container">
        <div>You need to be logged in to access this feature</div>
      </div>
    );
  }
  ...
  return (
    <div className="container">
      <div>
        <h2 className="text-lg mt-6">Your Services</h2>
        <p className="text-gray-500 text-sm mb-2">Select a service category to post add a listing on</p>
        <div>
        ...
        {organizationMemberships.data.length === 0 && (
          <div className="border border-blue-200 bg-blue-50 p-4 rounded-md">
            No service category found assigned to your user
          </div>
        )}
